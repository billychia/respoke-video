...
var ui = {
    ...
    tweet: function () {
        ...
        function makeTweet() {
            ...
            var tweetText = "at #AstriCon " + username + " was in a video call with " + friendId + " using @respoke";
            var html = '<a href="https://twitter.com/intent/tweet?button_hashtag=AstriCon2014&text='+ tweetText + '"class="twitter-hashtag-button" id="tweet" data-related="billychia">Tweet #AstriCon</a>';
